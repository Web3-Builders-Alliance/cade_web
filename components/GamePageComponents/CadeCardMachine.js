    ...
    return (
        <>
            <div className='flex flex-col h-max relative'>
                ...
                <div id='first' style={{ height: "30rem", borderWidth: "11px" }} className={`z-10 relative flex flex-col justify-center items-center bg-${color} w-80 rounded-3xl border-black`}>
