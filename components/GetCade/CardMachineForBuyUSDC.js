    ...
    return (
        <>
            <div className='flex flex-col h-max relative overflow-x-hidden'>
                <div id='first' style={{ height: "34rem", borderWidth: "10px", width: "320px" }} className={`z-10 relative flex flex-col justify-center  bg-orange-500 items-center rounded-3xl border-gray-300 m-10`}>
                    <div className='w-72 h-80 bg-transparent rounded-xl'>
                        ...
                        <div className='absolute top-1/4 -translate-y-1/4'>
                            <div style={{ height: "15rem" }} className='relative border-4 border-blue-950  rounded-xl  w-72 bg-blue-800'>
                        ...
                        <div style={{ height: "11rem" }} className='absolute top-1/2 translate-y-1/3 mb-1 border-4 border-gray-500 rounded-xl w-72 bg-slate-800 flex justify-center items-center'>
                            {!onMainnet ? (
                                <>
                                ...
                                <>
                                    <div className='flex flex-col'>
                                        ...
                                        <div className='h-1/2 flex flex-row mt-3 mb-1'>
                                            <div className='flex flex-col justify-center items-center w-1/3 ml-1'>
                                                <h1 className='text-white font-abc text-xl'>Select and Pay</h1>
                                            </div>
                                            <div onClick={doTransactionWithUSDC} className='flex  flex-col items-center w-1/3 cursor-pointer'>
                                                ...
                                                <h1 className='text-white font-abc text-xl'>USDC</h1>
                                            </div>
                                            <div onClick={doTheTransactionWithBONK} className='flex flex-col items-center  w-1/3 cursor-pointer'>
                                                ...
                                                <h1 className='text-white font-abc text-xl'>BONK</h1>
                                            </div>
                                        </div>
                                    </div>
                                </>
